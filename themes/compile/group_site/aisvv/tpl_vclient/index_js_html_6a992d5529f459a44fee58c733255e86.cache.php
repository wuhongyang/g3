	...
	if(obj.length > 0 || obj){
		...
		for(var i in obj){
			if(artistListJson[obj[i].uin]){
				...
				obj[i].hasplay=artistListJson[obj[i].uin].hasplay;
				html += '<li id="L_J_'+obj[i].uin+'"><div class="thumbnail room"><a href="javascript:;" onclick="external.cpp_goSrc(\'/v/'+obj[i].room_id+'?vclient\',\''+obj[i].nick+'\')" title="'+obj[i].nick+'"><img src="'+cdn_url('<?php echo PIC_API_PATH;?>/uin/'+obj[i].uin+'big/150/110.jpg')+'" class="img" width="150" height="110" alt="'+obj[i].nick+'" title="'+obj[i].nick+'" /></a><p class="look">'+obj[i].curuser+'人正在观看...</p>';
				if(obj[i].hasplay){
					html += '<p class="zhibo">直播中</p>';
				}
				html += '<p><a href="javascript:;" onclick="external.cpp_goSrc(\'/v/'+obj[i].room_id+'?vclient\',\''+obj[i].nick+'\')" title="'+obj[i].nick+'" class="name">'+obj[i].nick+'</a></p><p class="listen" style="display:none;" id="'+sub_id+'_'+obj[i].uin+'">'+obj[i].uin+'</p><p class="num"><span id="J_'+sub_id+'_'+obj[i].uin+'" class="J_'+obj[i].uin+'"></span></span>艺人ID:'+obj[i].uin+'</p></div></li>';
			}
			else{
				html += '<li id="L_J_'+obj[i].uin+'"><div class="thumbnail room"><a href="/service/home.php?user='+obj[i].uin+'&SessionKey='+Token+'" title="'+obj[i].nick+'" target="_blank"><img src="'+cdn_url('<?php echo PIC_API_PATH;?>/uin/'+obj[i].uin+'big/150/110.jpg')+' class="img" width="150" height="110" alt="'+obj[i].nick+'" title="'+obj[i].nick+'" /></a><p><a href="/service/home.php?user='+obj[i].uin+'&SessionKey='+Token+'" title="'+obj[i].nick+'" target="_blank" class="name">'+obj[i].nick+'</a></p><p class="listen" style="display:none;" id="'+sub_id+'_'+obj[i].uin+'">'+obj[i].uin+'</p><p class="num"><span id="J_'+sub_id+'_'+obj[i].uin+'" class="J_'+obj[i].uin+'"></span></span>艺人ID:'+obj[i].uin+'</p></div></li>';
			}
		}
		html +='</ul>';
		if(page!=''){
	...
	if(obj.length > 0|| obj){
		...
		for(var i in obj){
			if(parseInt(obj[i].id) > 0){
				...
				html += '<li id="L_R_'+obj[i].id+'"><div class="thumbnail room"><a href="javascript:;" onclick="external.cpp_goSrc(\'/v/'+obj[i].id+'?vclient\',\''+obj[i].name+'\')" title="'+obj[i].name+'"><img src="'+cdn_url('<?php echo PIC_API_PATH;?>/roomid/'+obj[i].id+'/150/110.jpg')+'" width="150" height="110" alt="'+obj[i].name+'" title="'+obj[i].name+'" class="img" /></a><p class="look">'+obj[i].curuser+'人正在观看...</p>';
                if(parseInt(obj[i].hasplay)>0){
					html += '<p class="zhibo">直播中</p>';
				}
                html += '<p><a href="javascript:;" onclick="external.cpp_goSrc(\'/v/'+obj[i].id+'?vclient\',\''+obj[i].name+'\')" title="'+obj[i].name+'" class="name">'+obj[i].name+'</a></p><p class="collect" style="display:none;" id="'+sub_id+'_'+obj[i].id+'">'+obj[i].id+'</p><p class="num"><span id="R_'+sub_id+'_'+obj[i].id+'" class="R_'+obj[i].id+'"></span>房间号：'+obj[i].id+'</p></div></li>';
			}
		}
		html +='</ul>';
		if(page!=''){
