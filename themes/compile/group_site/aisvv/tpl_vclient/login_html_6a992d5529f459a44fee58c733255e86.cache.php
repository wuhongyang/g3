...
<div class="user" id="J_login_info" style="display: none;">
    <div class="clearfix">
        <div class="pull-left userface"><a href="/service/profile.php" target="_blank" class="sessionUrl1"><img id="userimgurl" width="70" height="70"></div>
        <div class="pull-left userinfo">
            <div class="username"><a href="/service/profile.php" target="_blank" class="sessionUrl1 welcome-name">{*name*}</a></div>
            <div class="verify">
    ...
    <div class="userbalance">
    	<div class="clearfix"><span class="pull-left">ID：{*uin*}</span> <a href="/service/profile.php" target="_blank" title="未读消息" class="sessionUrl1 pull-right">消息 (<span id="J_unread">0</span>)</a></div>
        ...
        <?php } ?>
        <div class="clearfix"><span class="pull-left">金币：{*voucher*}</span><a href="/shop/index.php?groupId=<?php echo $groupId;?>" target="_blank" class="sessionUrl2 pull-right">获取金币</a></div>
	</div>
