        ...
        <?php if(is_array($val['child'])) {foreach((array)$val['child'] as $key2=>$val2) {?>
            <div class="tab-pane<?php if($key2==0) { ?> active<?php } ?>" id="recommend_<?php echo $val2['id'];?>">
                ...
                <?php if($val['type']==1) { ?>
                    <li>
                        <div class="thumbnail room">
                            <a href="/v/<?php echo $val3['id'];?>" target="_blank" title="<?php echo $val3['name'];?>"><img src="<?php echo STATIC_API_PATH;?>/frontend/plugin/lazyload/default.gif" class="img" data-original="<?php echo cdn_url(PIC_API_PATH.'/roomid/'.$val3['id'].'/150/110.jpg');;?>" width="150" height="110" alt="<?php echo $val3['name'];?>" title="<?php echo $val3['name'];?>" /></a>
                            <p class="look"><?php echo $val3['curuser'];?>人正在观看...</p>
                            <?php if($val3['hasplay']>0) { ?>
                            <p class="zhibo">直播中</p>
                            <?php } ?>
                            <p><a href="/v/<?php echo $val3['id'];?>" target="_blank" title="<?php echo $val3['name'];?>" class="name"><?php echo $val3['name'];?></a></p>
                ...
                <?php } elseif ($val['type']==4) { ?>
                    <li>
                        <div class="thumbnail room">
                            <a href="/v/<?php echo $val3['room_id'];?>" title="<?php echo $val3['nick'];?>" target="_blank">
                            ...
                            <p class="zhibo">直播中</p>
                            <?php } ?>
                            <p><a href="/v/<?php echo $val3['room_id'];?>" title="<?php echo $val3['nick'];?>" target="_blank" class="name"><?php echo $val3['nick'];?></a></p>
