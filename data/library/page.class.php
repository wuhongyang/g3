...
class page
{
	...
	*/
	protected function open_ajax($action) {
		$this->is_ajax = true;
	...
	* @return string
	*/
	protected function next_page($style = '') {
	...
	* @return string
	*/
	protected function pre_page($style = '') {
		if ($this->nowindex > 1) {
	...
	* @return string
	*/
	protected function first_page($style = '') {
		if ($this->nowindex - 5 < 1) {
			return '';
			//return '<span class="'.$style.'">'.$this->first_page.'</span>';
		} else {
			$str = '<span class = "curr1">...</span>';
		}
		$str = $this->_get_link($this->_get_url(1), $this->first_page, $style).$str;
		return $str;
	}
	...
	* @return string
	*/
	protected function last_page($style = '') {
		if ($this->nowindex + 5 >= $this->totalpage) {
			return;
			//return '<span class="'.$style.'">'.$this->last_page.'</span>';
		}
		return '<span class="curr1">...</span>' . $this->_get_link($this->_get_url($this->totalpage), $this->last_page, $style);
	}

	protected function nowbar($style = '', $nowindex_style = '') {
	...
	* @return string
	*/
	protected function show($mode = 1) {
		switch ($mode) {
			case '1' :
				$this->next_page = '下一页';
				$this->pre_page = '上一页';
